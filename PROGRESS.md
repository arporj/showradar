...
2. [ ] **Estatísticas + retrospectiva** — horas assistidas, gêneros dominantes, séries concluídas no ano, "Retrospectiva" compartilhável (efeito Spotify Wrapped; Trakt cobra isso no VIP, TV Time tinha e morreu). Todos os dados já existem no banco (`user_episode_progress` + runtime + gêneros) — melhor custo-benefício do backlog inteiro.
...
9. [ ] **Melhorar o layout do e-mail de notificação** — o e-mail atual é funcional mas muito simples: só título, episódio e botão sobre fundo branco. Melhorias desejadas: identidade visual do ShowRadar (logo, cores, tipografia), imagem de capa do título/episódio, informações mais ricas (sinopse curta, número/nome do episódio formatado), rodapé padronizado com link de cancelamento e branding. Referência visual: screenshot capturado em 2026-07-17 mostrando o e-mail minimalista enviado via Brevo para o episódio T3E3 de Silo.
