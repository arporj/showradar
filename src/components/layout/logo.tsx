...
// 1. 3 anéis com cores de referência (interno slate/cinza, médio teal, externo ciano brilhante).
...
// 5. Círculo central e vetor de varredura no slate/cinza.
export function LogoMark({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      {/* 1. Anel Externo - Ciano - Gaps a 135° */}
      <circle
        cx="256"
        cy="256"
        r={r1}
      ...
      {/* 3. Anel Interno - Slate - Gaps a 135° */}
      <circle
        cx="256"
        cy="256"
        r={r3}
